...
public class AnimatorControllerTriggers : MonoBehaviour
{
    ...
    private void Update()
    {
         ...
         * Controller, and then type that name into the _anim.SetTrigger line where indicated. Be sure to spell it and case it exactly the same!
         *
        ...
        {
            _anim.SetTrigger("YOUR_TRIGGER_NAME_HERE_INSIDE_THE_QUOTES");
        }
